...
<html lang="en">
  ...
  <body>
	...
	<h3> Option list visible when click input box </h3>
	<h3>For filter the value from middle of the name</h3>
	<h3>Option comes in alphabatical order from database</h3>
	<form>
	...
	$(document).ready(function() {
		function fetchUniversities() {
			$.ajax({
				type: "GET",
				url: "testing_autocomplete_university4.php",
				data: '',
				beforeSend: function() {
		...
		$("#prev_uni").keyup(function() {
			...
			$.ajax({
				type: "GET",
				url: "testing_autocomplete_university4.php",
				data: 'prev_uni_keyword=' + inputValue,
				beforeSend: function() {
					$("#prev_uni").css("background", "#FFF url(LoaderIcon.gif) no-repeat 165px");
				},
				success: function(data) {
