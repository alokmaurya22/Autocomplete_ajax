...
$erp_link = mysqli_connect("p:localhost","root","mysql","cloudice_knipss_2023");

$db = mysqli_connect("p:localhost", "root", "mysql", "knipssex_2023");
function show_db(){
	$connect = mysqli_connect("p:localhost", "root", "mysql", "knipssex_2023");
	if(!$connect){
...
echo '<h1 style="width:58%; text-align:center; margin-top:40px; margin-left:35px; border-bottom:0px; text-decoration: underline; float:left; color:#027cd1; font-size:23px; background:#eee;">'.$col_name['value'].'</h1>';
